...
import { Activity, ArrowUpRight, BarChart3, Database, FileUp, Gamepad2, Link2, LoaderCircle, Search, Sparkles, Table2 } from "lucide-react";
import { api } from "./api";
...
export default function App() {
  const [view, setView] = useState<"data" | "prep" | "dashboard" | "pipeline" | "lol">("data");
  ...
  const viewTitle = { data: active?.name ?? "새 데이터로 분석을 시작하세요", prep: "전처리 레시피", dashboard: "대시보드 편집기", pipeline: "파이프라인 작업", lol: "LoL 데이터 실험실" }[view];
